...
```bash
java -jar japicmp-0.25.6-jar-with-dependencies.jar -n new-version.jar -o old-version.jar --new-classpath other-library-v2.jar
...
```bash
java -cp japicmp-0.25.6-jar-with-dependencies.jar;otherLibrary.jar japicmp.JApiCmp -n new-version.jar -o old-version.jar
```

For reporting purposes you can also provide more than one jar as old or new version(s):

```bash
java -jar japicmp-0.25.6-jar-with-dependencies.jar -o lib1-old.jar;lib2-old.jar -n lib1-new.jar;lib2-new.jar
```
